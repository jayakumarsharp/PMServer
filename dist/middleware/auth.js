...
var _require2 = require("../expressError"),
  UnauthorizedError = _require2.UnauthorizedError;
...
function ensureSameUserAsParam() {
  var param = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "username";
...
function ensureCorrectPortfolio(_x, _x2, _x3) {
  return _ensureCorrectPortfolio.apply(this, arguments);
} // Blocks the request if the authenticated user doesn't own the holding
function _ensureCorrectPortfolio() {
  _ensureCorrectPortfolio = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res, next) {
    var user;
...
function ensureCorrectHolding(_x4, _x5, _x6) {
  return _ensureCorrectHolding.apply(this, arguments);
}
function _ensureCorrectHolding() {
  _ensureCorrectHolding = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res, next) {
    var user;
...
module.exports = {
  ...
  ensureSameUserAsParam: ensureSameUserAsParam,
  ensureCorrectPortfolio: ensureCorrectPortfolio,
  ensureCorrectHolding: ensureCorrectHolding
};
