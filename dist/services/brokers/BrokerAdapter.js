 ...
 */
var BrokerAdapter = exports.BrokerAdapter = /*#__PURE__*/function () {
  /** @param {object} credentials — apiKey, apiSecret, accessToken, etc. */
  function BrokerAdapter(credentials) {
    _classCallCheck(this, BrokerAdapter);
    this.credentials = credentials;
  }

  /** Returns the broker's display name */
  return _createClass(BrokerAdapter, [{
    key: "name",
    get: function get() {
    ...
    key: "exchangeCode",
    value: (function () {
      var _exchangeCode = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(_code) {
      ...
      var _getMargins = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              throw new Error("getMargins() not implemented");
            case 1:
            case "end":
