  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(file) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          newFileUpload = new _Fileupload["default"]({
            filename: file.filename,
            filepath: file.path
          });
          _context2.next = 4;
          return newFileUpload.save();
        case 4:
          _fs["default"].createReadStream(file.path).pipe((0, _csvParser["default"])()).on('data', /*#__PURE__*/function () {
              ...
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  ...
                  case 2:
                    ...
                    newRecord = new _SecurityMaster.securityMaster({
                      symbol: row.Symbol || row.symbol
                    });
                    _context.next = 7;
                    return newRecord.save();
                  case 7:
                    console.log("Imported: ".concat(row.Symbol || row.symbol));
                    _context.next = 11;
                    break;
                  case 10:
                    console.log("Skipping duplicate: ".concat(row.Symbol || row.symbol));
                  case 11:
                  case "end":
          ...
          return _context2.abrupt("return", newFileUpload);
        case 8:
          _context2.prev = 8;
