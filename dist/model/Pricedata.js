...
var PriceDataSchema = new mongoose.Schema({
  securityMaster_id: {
...
var PriceData = exports.PriceData = mongoose.model("PriceData", PriceDataSchema);

// Insert or update price data
function updateprice(_x) {
  return _updateprice.apply(this, arguments);
}
function _updateprice() {
  _updateprice = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(Obj) {
    var securitydata, security_id, updatedPriceData;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          _context.next = 7;
          return PriceData.findOneAndUpdate({
            ...
            twoHundredDayAverageChangePercent: Obj.twoHundredDayAverageChangePercent,
        ...
        case 7:
          updatedPriceData = _context.sent;
          return _context.abrupt("return", updatedPriceData);
        case 11:
          _context.prev = 11;
