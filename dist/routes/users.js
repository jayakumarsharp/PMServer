...
var _require3 = require("../validations/schemas"),
  validate = _require3.validate,
  registerSchema = _require3.registerSchema,
  loginSchema = _require3.loginSchema,
  watchlistSchema = _require3.watchlistSchema;
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return User.getComplete(req.params.username);
        case 3:
          user = _context3.sent;
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          console.log(req);
          _context4.next = 4;
          return User.addToWatchlist(req.params);
        case 4:
          return _context4.abrupt("return", res.json({
            watched: req.params.symbol
          }));
        case 7:
          _context4.prev = 7;
...
userRouter.post("/watchlist", ensureCorrectUser, /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res, next) {
    var _req$body2, username, symbol, user, watchlistAdded;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          _context5.prev = 0;
          _req$body2 = req.body, username = _req$body2.username, symbol = _req$body2.symbol;
          user = {
            username: username,
            symbol: symbol
          }; //obj
  ...
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res, next) {
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          _context6.prev = 0;
          _req$body3 = req.body, username = _req$body3.username, symbol = _req$body3.symbol;
          user = {
            username: username,
            symbol: symbol
          }; //obj
...
userRouter.post('/token', validate(loginSchema), /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(req, res, next) {
    var _req$body4, username, password, user, token;
